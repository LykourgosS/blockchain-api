...
public class MinerBenchmark {
    ...
    @Benchmark
    public void javaAPIMultiThreadMiningV2(MultiThreadMinerState minerState, BlockState blockState){
        minerState.getJavaAPIMultiThreadMinerV2().mineFor(blockState.getBlock());
    }
